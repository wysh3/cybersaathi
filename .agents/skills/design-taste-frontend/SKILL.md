...
This skill follows the public taste-skill direction from Leonxlnx/taste-skill:
https://github.com/Leonxlnx/taste-skill

CyberSaathi agents must apply it with the stricter CyberSaathi product constraints in AGENTS.md: emergency-first workflows, public-sector trust, accessibility, privacy, no generic AI-purple styling, and no marketing-page-first rebuild.
